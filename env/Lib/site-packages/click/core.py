...
class BaseCommand:
    ...
    def _main_shell_completion(
        ...
        that, then exit early. Called from :meth:`flaskblog` before the
        program is invoked.
...
class MultiCommand(Command):
    ...
    def resolve_command(
        ...
        # resolve things like --help which now should go to the flaskblog
        # place.
